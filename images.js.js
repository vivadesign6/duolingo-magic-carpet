// Immediately run image replacement when the script loads
document.addEventListener('DOMContentLoaded', function() {
    // Find all image tags
    document.querySelectorAll('img').forEach(img => {
        // Force all images to go through error handler to generate SVGs
        const originalSrc = img.getAttribute('src');
        if (originalSrc) {
            img.onerror = function() {
                generateSVG(this, originalSrc);
            };
            // Trigger error handler to replace with SVG
            img.src = '';
            img.src = originalSrc;
        }
    });
...
/**
 * Image generation for Magic Carpet Experience
 * This file creates SVG-based images for the carpet experience when real images are not available
 */

// Function to generate SVG for an image element
function generateSVG(imgElement, srcPath) {
    ...
    // Generate SVG
    const svgContent = window.createPlaceholderImage(lookupPath);
    if (svgContent) {
...
// Create placeholder paths for missing images
window.createPlaceholderImage = function(type, color1, color2) {
    const basePath = '/images/';
    
    switch(type) {
        // Pattern placeholders
        case 'patterns/classic.svg':
            return generatePatternSVG('classic', color1, color2);
        case 'patterns/geometric.svg':
            return generatePatternSVG('geometric', color1, color2);
        case 'patterns/floral.svg':
            return generatePatternSVG('floral', color1, color2);
        case 'patterns/arabesque.svg':
            return generatePatternSVG('arabesque', color1, color2);
        case 'patterns/royal.svg':
            return generatePatternSVG('royal', color1, color2);
            
        // Pattern thumbnails
        case 'patterns/classic-thumb.svg':
            return generatePatternThumbnail('classic', color1, color2);
        case 'patterns/geometric-thumb.svg':
            return generatePatternThumbnail('geometric', color1, color2);
        case 'patterns/floral-thumb.svg':
            return generatePatternThumbnail('floral', color1, color2);
        case 'patterns/arabesque-thumb.svg':
            return generatePatternThumbnail('arabesque', color1, color2);
        case 'patterns/royal-thumb.svg':
            return generatePatternThumbnail('royal', color1, color2);
            
        // Thread patterns
        case 'threads/standard.svg':
            return generateThreadSVG('standard', color1);
        case 'threads/silver.svg':
            return generateThreadSVG('silver', color1);
        case 'threads/gold.svg':
            return generateThreadSVG('gold', color1);
        case 'threads/magical.svg':
            return generateThreadSVG('magical', color1);
            
        // Effects
        case 'effects/sound-waves.svg':
            return generateEffectSVG('sound-waves', color1);
        case 'effects/interactive-particles.svg':
            return generateEffectSVG('particles', color1);
        case 'effects/personalized-blend.svg':
            return generateEffectSVG('personalized', color1);
        case 'effects/diamond-sparkle.svg':
            return generateEffectSVG('diamond-sparkle', color1);
        case 'effects/gold-glow.svg':
            return generateEffectSVG('gold-glow', color1);
            
        // Icons
        case 'icons/visual-learner.svg':
            return generateIconSVG('visual', color1);
        case 'icons/auditory-learner.svg':
            return generateIconSVG('auditory', color1);
        case 'icons/kinesthetic-learner.svg':
            return generateIconSVG('kinesthetic', color1);
        case 'icons/personalized-learner.svg':
            return generateIconSVG('personalized', color1);
        case 'icons/streak-icon.svg':
            return generateIconSVG('streak', color1);
        case 'icons/gems-icon.svg':
            return generateIconSVG('gems', color1);
        case 'icons/league-icon.svg':
            return generateIconSVG('league', color1);
        ...
        // Personas
        case 'persona-samuel.svg':
            return generatePersonaSVG('boy', '#4CAF50');
        case 'persona-amelia.svg':
            return generatePersonaSVG('girl', '#E91E63');
        case 'persona-daniel.svg':
            return generatePersonaSVG('boy2', '#FF9800');
            
        // Carpet examples
        case 'carpet-visual-learner.svg':
            return generateCarpetExampleSVG('visual', '#4CAF50');
        case 'carpet-auditory-learner.svg':
            return generateCarpetExampleSVG('auditory', '#E91E63');
        case 'carpet-kinesthetic-learner.svg':
            return generateCarpetExampleSVG('kinesthetic', '#FF9800');
            
        // Premium features
        case 'carpet-free.svg':
            return generateCarpetCompareSVG('free');
        case 'carpet-premium.svg':
            return generateCarpetCompareSVG('premium');
        case 'premium/premium-patterns.svg':
            return generatePremiumFeatureSVG('patterns');
        case 'premium/premium-colors.svg':
            return generatePremiumFeatureSVG('colors');
        case 'premium/premium-threads.svg':
            return generatePremiumFeatureSVG('threads');
        case 'premium/premium-learning.svg':
            return generatePremiumFeatureSVG('learning');
        case 'premium/premium-league.svg':
            return generatePremiumFeatureSVG('league');
            
        // Achievements
        case 'achievements/streak-threads.svg':
            return generateAchievementSVG('streak');
        case 'achievements/gem-embellishments.svg':
            return generateAchievementSVG('gems');
        case 'achievements/league-heights.svg':
            return generateAchievementSVG('league');
            
        // Default fallbacks for any images
        case 'premium-feature-default.svg':
            return generatePremiumFeatureSVG('patterns');
        case 'Visual learner icon':
            return generateIconSVG('visual', '#1CB0F6');
        case 'Streak icon':
            return generateIconSVG('streak', '#FFD900');
        case 'League icon':
            return generateIconSVG('league', '#00BCD4');
        case 'Free Magic Carpet':
            return generateCarpetCompareSVG('free');
        case 'Premium Magic Carpet':
            return generateCarpetCompareSVG('premium');
        case 'Visual learner carpet':
            return generateCarpetExampleSVG('visual', '#4CAF50');
        case 'Auditory learner carpet':
            return generateCarpetExampleSVG('auditory', '#E91E63');
        case 'Kinesthetic learner carpet':
            return generateCarpetExampleSVG('kinesthetic', '#FF9800');
            
        default:
            // Check if the path includes known keywords
            if (type.includes('visual')) return generateCarpetExampleSVG('visual', '#4CAF50');
            if (type.includes('auditory')) return generateCarpetExampleSVG('auditory', '#E91E63');
            if (type.includes('kinesthetic')) return generateCarpetExampleSVG('kinesthetic', '#FF9800');
            if (type.includes('pattern')) return generatePatternSVG('classic', '#1CB0F6', '#0F8BC0');
            if (type.includes('streak')) return generateAchievementSVG('streak');
            if (type.includes('gem')) return generateAchievementSVG('gems');
            if (type.includes('league')) return generateAchievementSVG('league');
            if (type.includes('premium')) return generateCarpetCompareSVG('premium');
            if (type.includes('free')) return generateCarpetCompareSVG('free');
